...
import 'package:ayron_crm/data/repositories/contact_protocol/contact_protocol_repository_remote.dart';
  ...
  runApp(
    MultiProvider(
      providers: [
        ...
        Provider(
          create: (context) =>
              OpportunityContactRepositoryRemote(apiService: context.read())
                  as OpportunityContactRepository,
        ),
        Provider(
          create: (context) =>
              ContactProtocolRepositoryRemote(apiService: context.read())
                  as ContactProtocolRepository,
        ),
        Provider(
          create: (context) =>
