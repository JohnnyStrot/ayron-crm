...
import 'package:ayron_crm/ui/contact/contact_list_entry.dart';
import 'package:ayron_crm/ui/contact/contact_list_viewmodel.dart';
import 'package:flutter/material.dart';
import 'package:flutter_command/flutter_command.dart';

class ContactListView
    extends DataListView<Contact, ContactListViewmodel, ContactListView> {
  const ContactListView({super.key, required super.viewmodel});

  @override
  State<ContactListView> createState() => _ContactListViewState();
}

class _ContactListViewState
    extends DataListViewState<Contact, ContactListViewmodel, ContactListView> {
  ...
  Widget buildEntry(BuildContext context, Contact entity) {
    return ContactListEntry(contact: entity, onDelete: (org) => delete(org));
  }
